...
<?php
    ...
    <div class="cart">
        ...
        <h3>
            ...
            Giỏ hàng(<?php echo count($_SESSION["shopping_cart"]) ?>)
        </h3>

        <div class="table-responsive" id="order_table">
            <table class="table table-bordered table-stripped">
                <tr>
                    <th width="25%">Tên đồ uống</th>
                    ...
                    <th width="10%">Tổng</th>
                    <th width="10%">
                        <button class="btn2 btn-default btn-xs clear"> Xóa </button>
                    </th>
        ...
        <div class="place_order">
            <button class="btn" id="check_out">Thanh toán</button>
        </div>
    ...
    <?php }
        ...
        <div class="empty_cart">
            ...
            <h1>
                <a href="index.php"><i class="fas fa-arrow-left"></i></a>Giỏ hàng của bạn đang Trống!
            </h1>
        </div>
