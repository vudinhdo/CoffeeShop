...
<body>
   ...
   <input type="hidden" id="wishlist_section" value="wishlist" >
    ...
    <header>
        <a href="./index.php" class="logo"><i class="fa fa-coffee"></i>Chilling Cafe.</a>
    ...
    <section class="wishlist">
        ...
        <div class="products-container">
            ...
            <h3 class="title"><a href="./index.php"><i class="fas fa-arrow-left"></i></a> Yêu thích</h3>
                     ...
                     foreach($wishlist_data as $keys => $values){ ?>
                        ...
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <button class="btn addItemToCart"  id="<?php echo $values['product_id'] ?>"><i class="fas fa-cart-plus"></i> Thêm vào giỏ hàng</button>
                            </div>  
                        </div>
                    <?php } ?>
    ...
    <?php }
         ...
         <!-- if wishlist is empty -->
            ...
            <div class="empty_wishlist">
                ...
                <h1>
                    <a href="index.php"><i class="fas fa-arrow-left"></i></a>Danh sách yêu thích của bạn đang trống!
                </h1>
            </div>
    <?php } 
