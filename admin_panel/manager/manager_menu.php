			...
			<div class="main-content">
				<div id="tabbed_box" class="tabbed_box">
					...
					<div class="tabbed_area">
						...
						<ul class="tabs">
							<li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">Xem Danh mục</a></li>
							<li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">Thêm Danh mục</a></li>
						</ul>
