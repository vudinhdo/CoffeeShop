  ...
  <?php include_once('./includes/db_connect.php'); ?> 
   ...
   <input type="hidden" id="currency_list" value="<?php echo $currency_logo; ?>" >
    ...
    <section class="offer" id="offer"> 
         ...
         <h1 align="center">
             <a href="index.php"><i class="fas fa-arrow-left"></i></a>Ưu đãi
         </h1>       
            ...
            ?>
                    ...
                    <div class="box" id="box">
                        ...
                        <div class="content">
                            ...
                            <!-- add to cart buttons -->
                            <button id="<?php echo $row2['item_id'] ?>" class="btn addItemToCart"><i class="fas fa-cart-plus"></i> Thêm vào giỏ hàng</button>
                        </div>
                    </div>
    <?php  } ?>
        </div>
