            ...
            <!--  modal body -->
	      	<div class="modal-body">   
	        	...
	        	<div class="items">
                    ...
                    <div>
                        <h3 id="TOPPINGS">Chọn Toppings của bạn (không bắt buộc):</h3>
	        	...
	        	<div class="modal-footer">
                    <button type="button" class="btn-secondary" id="btn-close" data-dismiss="modal">Đóng</button>
                    <button type="button" class="btn-primary" id="btn-addToCart" > <i class="fas fa-cart-plus"></i> Giỏ hàng</button>
                </div>
	      	</div>
    	</div>
  	</div>
