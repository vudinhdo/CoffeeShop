<section class="menu" id="menu">
    <h3 class="sub-heading" data-aos="fade-up"> menu của chúng tôi </h3>
    <h1 class="heading" data-aos="fade-up"> Nổi bật trong hôm nay </h1>
...
?>
        ...
        <div class="box menu-tab-content <?php if($row['menu_id'] == 1){echo 'show';} ?>" data-aos="fade-up"  id="<?php  echo $row['menu_name']; ?>" >
            ...
            <div class="content">
                ...
                <!-- add to cart button -->
                <button class="btn addItemToCart" id="<?php echo $row['item_id'] ?>"><i class="fas fa-cart-plus"></i> Thêm vào giỏ hàng</button>  
